...
//let s = 30000 //等待延迟30s
const $ = new Env("【youth_read_qf_2】")
//const notify = $.isNode() ? require('./sendNotify') : '';
let ReadArr = [], YouthBody = "",readscore = 0;

  if (process.env.YOUTH_READ_QF_2 && process.env.YOUTH_READ_QF_2.indexOf('&') > -1) {
  YouthBody = process.env.YOUTH_READ_QF_2.split('&');
  console.log(`您选择的是用"&"隔开\n`)
  }
  else if (process.env.YOUTH_READ_QF_2 && process.env.YOUTH_READ_QF_2.indexOf('\n') > -1) {
  YouthBody = process.env.YOUTH_READ_QF_2.split('\n');

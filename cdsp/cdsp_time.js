...
let Account = ["【Sam】","【小爱豆】","【QF】","【RL】","【WYDSZ】","【月锡】"];
 ...
 if (process.env.CD_BD_TIME && process.env.CD_BD_TIME.indexOf('\n') > -1) {
  BD = process.env.CD_BD_TIME.split('\n');
  console.log(`您选择的是用换行隔开\n`)
  } 
  else
  {
